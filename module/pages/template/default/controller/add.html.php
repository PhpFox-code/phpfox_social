...
<div id="js_pages_add_holder">
	...
	<div class="pages_type_add_holder">
		<a href="#" class="pages_type_add_inner_link">
			<img style= "width:130px;height:105px;vertical-align:middle" src='http://www.freewaylights.com/theme/frontend/default/style/default/image/misc/{$aType.name|convert}.png'/>
			<span style="font-weight:bold">{$aType.name|convert}</span>
		</a>
