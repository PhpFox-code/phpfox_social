...
If you disable it extra checks will be added to try to preserve the original name of the file. If an item with the same name already exists the new one will have a number added at the end.</info>]]></phrase>
		...
		<phrase module_id="core" version_id="3.5.0beta1" var_name="setting_keep_files_in_server" added="1353415860"><![CDATA[<title>Keep Files In Server (CDN)</title><info>Set this to TRUE to keep original files on the server.
This setting only works if a CDN service is enabled.</info>]]></phrase>
