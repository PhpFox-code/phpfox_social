...
<?php $aContent = array (
  ...
  'setting_recaptcha' => '<title>Enable reCAPTCHA</title><info>By enabling <a href="http://recaptcha.net/" target="_blank">reCAPTCHA</a>, wherever we use a captcha routine to prevent spam it will be replaced with reCAPTCHA.
...
<b>Notice:</b> This feature is experimental and is not stable.</info>',
  ...
  'setting_recaptcha_header' => '<title>reCAPTCHA Header</title><info>You can modify the style of reCAPTCHA by adding JavaScript to the template header and by adding CSS to the same header or for each theme.

More information can be found <a href="http://code.google.com/intl/en/apis/recaptcha/docs/customization.html" target="_blank">here</a>.</info>',
