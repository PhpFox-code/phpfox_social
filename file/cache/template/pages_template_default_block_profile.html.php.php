...
<?php /* Cached: January 12, 2014, 12:02 pm */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
<?php if (count((array)$this->_aVars['aPagesList'])):  $this->_aPhpfoxVars['iteration']['pages'] = 0;  foreach ((array) $this->_aVars['aPagesList'] as $this->_aVars['aPageDetails']):  $this->_aPhpfoxVars['iteration']['pages']++; ?>

<div class="pages_profile_block"<?php if ($this->_aPhpfoxVars['iteration']['pages'] > 6): ?> style="display:none;"<?php endif; ?>>
	<a href="<?php echo $this->_aVars['aPageDetails']['url']; ?>" title="<?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aPageDetails']['title']); ?>">
<?php if ($this->_aVars['aPageDetails']['is_app']): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('server_id' => 0,'path' => 'app.url_image','file' => $this->_aVars['aPageDetails']['aApp']['image_path'],'suffix' => '_200','max_width' => 75,'max_height' => 75,'force_max' => true,'no_link' => true)); ?>
<?php else: ?>
<?php if (isset ( $this->_aVars['aPageDetails']['image_overwrite'] )): ?>
				<img src="<?php echo $this->_aVars['aPageDetails']['image_overwrite']; ?>" width=75 height=75>
<?php else: ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aPageDetails'],'suffix' => '_200','max_width' => 75,'max_height' => 75,'no_link' => true,'is_page_image' => true)); ?>
<?php endif; ?>
<?php endif; ?>
	</a>
	<div>		
		<a href="<?php echo $this->_aVars['aPageDetails']['url']; ?>" title="<?php echo Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aPageDetails']['title']); ?>"><?php echo Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aPageDetails']['title']), 20, '...'); ?></a>
	</div>
</div>
<?php if (is_int ( $this->_aPhpfoxVars['iteration']['pages'] / 5 )): ?>
<div class="clear"></div>
<?php endif;  endforeach; endif; ?>
<div class="clear"></div>
<?php if (count ( $this->_aVars['aPageDetails'] )): ?>
<a href="#" class="pages_profile_view_more" onclick="$('.pages_profile_block').show(); $(this).hide(); return false;"><?php echo Phpfox::getPhrase('pages.more'); ?></a>
<?php endif; ?>
