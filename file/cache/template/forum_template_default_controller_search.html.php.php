...
<form method="post" action="<?php if ($this->_aVars['aCallback'] === false):  echo Phpfox::getLib('phpfox.url')->makeUrl('forum.search');  else:  echo Phpfox::getLib('phpfox.url')->makeUrl('forum.search', array('module' => 'pages','item' => $this->_aVars['aCallback']['group_id']));  endif; ?>">
