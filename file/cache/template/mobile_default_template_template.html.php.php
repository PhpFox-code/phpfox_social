...
<?php /* Cached: December 15, 2013, 7:06 am */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
<?php if (!$this->bIsSample): ?><div id="site_content"><?php if (isset($this->_aVars['bSearchFailed'])): ?><div class="message">Unable to find anything with your search criteria.</div><?php else:  $sController = "apps.index";  if ( Phpfox::getLib("template")->shouldLoadDelayed("apps.index") == true ): ?>
<div id="delayed_block_image" style="text-align:center; padding-top:20px;"><img src="http://freewaylights.com/theme/frontend/default/style/default/image/ajax/add.gif" alt="" /></div>
